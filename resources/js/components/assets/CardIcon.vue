...
export default {
    ...
    props: {
        ...
        hover: { type: String, default: '#000' },
        isHover: { type: Boolean, default: false },
    },
    setup(props) {
        const realFill = computed(() => (props.isHover ? props.hover : props.fill))
        return { realFill }
    }
}
</script>
